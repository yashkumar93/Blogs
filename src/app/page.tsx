        ...
        <BlurFade>
          <header className="mb-12 sm:mb-16">
            ...
            <nav className="flex items-center gap-5 text-xs sm:text-sm text-muted-foreground" aria-label="Primary">
              <Link href="/" className="text-foreground font-medium">All</Link>
        ...
        <section>
          ...
          {totalPages > 1 && (
            <BlurFade delay={0.3}>
              ...
              >
                {page > 1 ? (
                  <Link href={page === 2 ? "/" : `/?page=${page - 1}`} className="hover:text-foreground transition-colors">
                    ← Previous
                  </Link>
                ) : <span />}
                ...
                {page < totalPages ? (
                  <Link href={`/?page=${page + 1}`} className="hover:text-foreground transition-colors">
                    Next →
                  </Link>
                ) : <span />}
              </nav>
